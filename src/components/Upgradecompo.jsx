export default function Upgradecompo(){
    ...
    return(
      <div className="flex-1 pt-[535px] ">
      <div className="flex-col items-end justify-end">
      
       <div className="grid bg-red h-screen ">
       <div className="grid grid-flow-row-dense place-items-start gap-1.5 grid-cols-7 grid-rows-2  w-[236px] h-[56px] px-[8px] py-[10px]   hover:bg-[#212121] rounded-lg ">
       <div className="col-span-1 row-span-2 place-self-center ">
       <div className=" border border-[#2f2f2f] rounded-full ">
       <div className=" flex justify-center items-center  w-6 h-6 text-current">
      <svg
    ...
    <span className="line-clamp-1 text-xs text-[#9b9b9b]">
