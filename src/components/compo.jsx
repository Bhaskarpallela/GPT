...
const CreateImageButton = () => {
  ...
  return (
    <div   className="mr-3 ">
    <button
      className="group relative flex h-[42px] items-center gap-1.5 outline-none rounded-full border border-[#2f2f2f] px-3 py-2 text-start text-[13px] shadow-xxs transition enabled:hover:bg-[#2f2f2f] :cursor-not-allowed xl:gap-2 xl:text-[13px]"
    >
      <svg
        width="18"
        height="18"
      ...
      <span className="max-w-full select-none whitespace-nowrap text-[#b4b4b4] transition group-hover:text-white dark:text-gray-400">
        Create image
      </span>
    </button>
    </div>
...
function GetAdviceButton () {
  return (
    <div className="mr-3">
    <button
    className="group relative flex h-[42px] items-center gap-1.5 rounded-full border border-[#2f2f2f] px-3 py-2 text-start text-[13px] shadow-xxs transition enabled:hover:bg-[#2f2f2f] :cursor-not-allowed xl:gap-2 xl:text-[13px]"
    >
      <svg
      ...
      <span className="text-gray-400 group-hover:text-white dark:text-gray-400">
        Get advice
      </span>
    </button>
    </div>
...
const SummarizeButton = () => {
  return (
    ...
    >
      ...
      <span className="max-w-full select-none whitespace-nowrap text-gray-600 transition group-hover:text-white dark:text-gray-400">
        Summarize text
      </span>
    </button>
    </div>
  ...
  >
    ...
    >
      <path 
        fill-rule="evenodd" 
        clip-rule="evenodd" 
        d="M12 3C8.41496 3 5.5 5.92254 5.5 9.53846C5.5 11.8211 6.662 13.8298 8.42476 15H15.5752C17.338
        13.8298 18.5 11.8211 18.5 9.53846C18.5 5.92254 15.585 3 12 3ZM14.8653 17H9.13473V18H14.8653V17ZM13.7324 20H10.2676C10.6134 20.5978 11.2597
        21 12 21C12.7403 21 13.3866 20.5978 13.7324 20ZM8.12601 20C8.57004 21.7252 10.1361 23 12 23C13.8639 23 15.43 21.7252 15.874 20C16.4223 19.9953 
        16.8653 19.5494 16.8653 19V16.5407C19.0622 14.9976 20.5 12.4362 20.5 9.53846C20.5 4.82763 16.6992 1 12 1C7.30076 1 3.5 4.82763 3.5 9.53846C3.5 12.4362 4.93784 14.9976 7.13473 16.5407V19C7.13473 19.5494 7.57774 19.9953 8.12601 20Z" 
        fill="currentColor"
      ></path>
    </svg>
    <span className="max-w-full select-none whitespace-nowrap text-gray-600 transition group-hover:text-white dark:text-gray-400">
...
const More=()=>{
    return(
        <div >
        <button onClick={()=>setopenMore(curr=>!curr)} className="group relative flex h-[42px] items-center gap-1.5 rounded-full border border-[#2f2f2f] px-3 py-2 text-start text-[13px] shadow-xxs transition enabled:hover:bg-[#2f2f2f] :cursor-not-allowed xl:gap-2 xl:text-[13px]"
        >
        <span className="max-w-full select-none whitespace-nowrap text-gray-600 transition group-hover:text-white dark:text-gray-400">
        more
      </span>
    ...
    return(
      ...
      <div className="flex-1 mt-3  h-44 justify-center">
        {
          openMore&&
